...
def evaluate_generator(cfg, model_cfg, wgan, dataset_dict, gen_file_name) -> dict:
    ...
    # gen_scores["MiFID_Score"] = get_mifid_score(real_images, fake_images, verbose=verbose)
    # gen_scores["VIF_Score"] = get_vif_score(real_images, fake_images, verbose=verbose)
    # gen_scores["LPIPS_Score"] = get_lpips_score(real_images, fake_images, verbose=verbose)
